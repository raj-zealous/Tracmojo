...
- (void)setImage:(UIImage *)image
{
    ...
    if ([_delegate respondsToSelector:@selector(loadingFinished:)])
    {
        [_delegate loadingFinished:self];
    }
...
-(void)loadingFinished:(AsyncImageView *)AsyncImageView {
    
   // DLog(@"loadingFinished->stop loading");
}
