...
@property (nonatomic, weak) UILabel *lbl_;
...
- (void)initializer
{
    ...
    self.rightUtilityClipView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    self.rightUtilityClipView.layer.borderWidth = 1.0f;
